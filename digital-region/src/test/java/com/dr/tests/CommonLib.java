...
public class CommonLib {
	...
	public HorairesEtAchats horairesetachats;
	...
	private void setupChromeDriver(String url) {
		...
		//System.setProperty("webdriver.chrome.driver", new File("C:\\Users\\mahdigharsallah\\eclipse\\java-oxygen\\eclipse\\chromedriver.exe").getAbsolutePath());
